...
void flushPendingBitsAndClear(bool bit, bytes_number_type &pendingBitsCounter, std::vector<bool> &bitsBuffer) {
...
int main(int argc, char *argv[]) {
    if (argc != 3) {
        std::cout << "Bad input!. Correct input is: ./encoder <file to encode> <output file>\n";
        return -1;
    }
